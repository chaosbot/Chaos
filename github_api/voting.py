...
def get_voting_window(now):
    """ returns the current voting window for new PRs. 24 hours by default
    to give the same treatment to users in all timezones"""

    seconds = 24 * 60 * 60 * settings.VOTE_WINDOW_SCALE
    return seconds
